...
public class DBConfig {
	...
	// 아래 부분은 AOP를 이용해서 트랜젝션 처리를 하기 위한 Bean
	...
	*/
	...
	public Advisor advisor() {
		...
		*/
		...
		return new DefaultPointcutAdvisor(pointCut, transactionInterceptor());	// poinrCut으로 등록된 메소드에 transactionInterceptor()를 동작시킨다.
	}
