...
public class BoardController {
	...
	*/
	...
	// 반환타입 String : 이동할 jsp 이름을 반환한다. 반환된 이름은 servlet-contetxt.xml의 ViewResolver에 의해서 rendering된다. (prefix + 반환값 + suffix)
	public String index() {
		return "index";
	}
	/*
	...
	*/
	...
	/*
	@GetMapping("/detail.do")
	public void getDetail(BoardDTO board) {	//board.setBoardNo()이 여기서 사용된다.
	...
	*/
	...
	@PostMapping("/detail.do")
	public String postDetail(@ModelAttribute("board") BoardDTO board) {	// 모델에 저장하는 속성명을 "board"로 하겠다.
		return "detail";
	}
