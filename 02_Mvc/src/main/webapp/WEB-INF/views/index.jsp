...
<body>
	...
	<div><a href="${contextPath}/detail.do?name=박기상">상세보기2</a></div>
	<div><a href="${contextPath}/detail.do?age=32">상세보기3</a></div>
	<div><a href="${contextPath}/detail.do?name=박기상&age=32">상세보기4</a></div>
	
	<h1>요청 파라미터-2</h1>
	<div><a href="${contextPath}/detail.me">상세보기1</a></div>
	<div><a href="${contextPath}/detail.me?name=박기상">상세보기2</a></div>
	<div><a href="${contextPath}/detail.me?age=32">상세보기3</a></div>
	<div><a href="${contextPath}/detail.me?name=박기상&age=32">상세보기4</a></div>
	
	<h1>요청 파라미터-3</h1>
	<div><a href="${contextPath}/detail.gdu">상세보기1</a></div>
	<div><a href="${contextPath}/detail.gdu?name=박기상">상세보기2</a></div>
	<div><a href="${contextPath}/detail.gdu?age=32">상세보기3</a></div>
	<div><a href="${contextPath}/detail.gdu?name=박기상&age=32">상세보기4</a></div>
	...
	<h1>Redirect</h1>
	<div><a href="${contextPath}/post/detail.do?name=박기상&age=32">상세보기</a></div>
	<div><a href="${contextPath}/post/detail.me?name=박기상&age=32">상세보기</a></div>
