...
public class MvcController {
	...
	*/
	...
	public String detailMe(@RequestParam(value="name", required = false, defaultValue="홍길동") String name, // 요청 파라미터 name이 없으면 "홍길동"을 사용한다.
						   @RequestParam(value="age", required = false, defaultValue="0") int age,			 // 요청 파라미터 age이 없으면 "0"을 사용한다.
						   Model model) {
	...
	*/
	...
	/*
	@GetMapping("/detail.gdu")
	public String detailGdu(@ModelAttribute(value="p") Person person) {	// Model에 저장할 속성명을 p로 해주세요
