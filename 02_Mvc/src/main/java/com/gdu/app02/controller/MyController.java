...
public class MyController {
	...
	*/
	...
	/*
		...
		@RequestMapping(value="list.do", method=RequestMethod.GET)	  value는 슬래시(/)로 시작하지 않아도 된다.(HandlerMapping이 알아서 찾아준다.)
	...
	*/
	...
	public String list() {
		...
		/*
			...
			하지만 실제로는 /WEB-INF/views/board/list.jsp 경로로 처리된다. (슬래시 두 개 // 는 무시됨)
		*/
	}
