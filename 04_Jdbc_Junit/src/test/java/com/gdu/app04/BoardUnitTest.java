...
/*
	...
	1. 어떤 방식으로 Spirng Container에 Bean을 등록했는지 알려주는 역할이다.
...
public class BoardUnitTest {
	...
	// DAO 메소드 단위로 Unit 테스트를 진행가기 위해서 BoardDAO 타입의 Bean이 필요하다.
	@Autowired
	...
	public void a2상세테스트() {
		...
		LOGGER.debug(board.toString());	// LOG기능으로 대체 완료
	...
	public void a5목록테스트() {
		...
		LOGGER.debug(list.toString());	// LOG기능으로 대체 완료
